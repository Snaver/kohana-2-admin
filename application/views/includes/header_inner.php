...
<div class="row top-buffer">
	<ul class="col-lg-2 nav nav-pills nav-stacked">
		...
		<li class="<?=(URI::segment(1) == 'example_1' ? 'active' : '');?>"><a href="<?=url::base();?>example_1">Example 1</a></li>
		<li class="<?=(URI::segment(1) == 'example_2' ? 'active' : '');?>"><a href="<?=url::base();?>example_2">Example 2</a></li>
