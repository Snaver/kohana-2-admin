...
<div class="pagination_container">
	<?php if ($previous_page): ?><a href="<?php echo str_replace('{page}', $previous_page, $url) ?>">&laquo;&nbsp;<?php echo Kohana::lang('pagination.previous') ?></a> | <?php endif ?>
	...
	<?php if ($next_page): ?> | <a href="<?php echo str_replace('{page}', $next_page, $url) ?>"><?php echo Kohana::lang('pagination.next') ?>&nbsp;&raquo;</a><?php endif ?>
</div>